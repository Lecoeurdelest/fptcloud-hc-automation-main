...
- [ ] **T-0301** — JSON Schema validates a correct `checklist.yml` (phase: P3.T1)
- [ ] **T-0302** — JSON Schema rejects missing `run_id` (phase: P3.T1)
- [ ] **T-0303** — JSON Schema rejects unknown fields (phase: P3.T1)
- [ ] **T-0304** — JSON Schema rejects invalid `cidr` format in vars (phase: P3.T1)
- [ ] **T-0305** — `ChecklistLoader` expands `defaults` into each test case (phase: P3.T2)
- [ ] **T-0306** — `ChecklistLoader` normalizes IDs: `1` → `TC-001` (phase: P3.T2)
- [ ] **T-0307** — `spec_hash` changes when spec content changes (phase: P3.T2)
- [ ] **T-0308** — `spec_hash` stable when spec content is identical (phase: P3.T2)
- [ ] **T-0309** — `DependencyResolver` topological sort: linear chain A→B→C (phase: P3.T3)
- [ ] **T-0310** — `DependencyResolver` rejects cycle A→B→A (phase: P3.T3)
- [ ] **T-0311** — `DependencyResolver.ready_tasks()` returns only unblocked tasks (phase: P3.T3)
- [ ] **T-0312** — `DependencyResolver.ready_tasks()` unblocks children when parent PASS (phase: P3.T3)
